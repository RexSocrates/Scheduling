...
@section('navbar')
    <font class="brand-logo light">調整班表<i class="material-icons arrow_right-icon">keyboard_arrow_right</i>初版班表<i class="material-icons arrow_right-icon">keyboard_arrow_right</i>張國頌</font>
@endsection
